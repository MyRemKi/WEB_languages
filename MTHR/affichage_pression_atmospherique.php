...
{ 
      ...
      echo '<body>';
		echo '<div id="conteneur">';
			echo '<div id="entete">';
					echo "<h1>Affichage de la Température et de l'Humidité Relative en F13</h1>";
			echo '</div>';
			echo '<div class="frame">';
				echo '<div class="gauche">';
					echo '<UL class="sommaire_vertical">';
						echo '<LI><A href="affichage_temperature_interieure.php">T° et  HR%  en F11 </A></LI>';
						echo '<LI><A href="affichage_hygrometrie_interieure.php">T° et  HR%  en F12</A></LI>';
						echo '<LI><A href="affichage_pression_atmospherique.php">T° et  HR%  en F13</A></LI>';
         	...
         	echo '<br>'; 
				...
				// on recherche les pressions atmosphériques
 				$sql="SELECT date_echantillon, temperature from \"donnees\"";// where (\"id_TypeDonneeMeteo\"='3');";
				$resultat=pg_exec($db,$sql);
				$lignes=pg_numrows($resultat);
				echo ("$lignes valeurs de températures et d'Humidités Relatives en F13<br><br>");
 				...
 				if ($lignes!= 0) 
				{
					...
					echo("</TR>");
					// on affiche chaque pression atmosphérique
					for ($i=0; $i < $lignes; $i++) 
					{ 
