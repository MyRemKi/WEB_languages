<?php
//affichage_comptes_negatifs.php
session_start ();  
...
{ 
      ...
      echo '<body>';
		echo '<div id="conteneur">';
			echo '<div id="entete">';
					echo "<h1>Affichage de la Température et de l'Humidité Relative en F12 </h1>";
			echo '</div>';
			echo '<div class="frame">';
         	...
         	echo '<br>'; 
				...
				// on recherche les températures intérieures
 				$sql="SELECT date_echantillon, temperature,humidite_relative from \"donnees\""; //where (\"id_TypeDonneeMeteo\"='2');";
				$resultat=pg_exec($db,$sql);
				$lignes=pg_numrows($resultat);
				echo ("$lignes valeurs de températures et d'Humidités Relatives en F12<br><br>");
 				...
 				if ($lignes!= 0) 
				{
					...
					echo("</TR>");
					// on affiche chaque hygrométrie intérieure
					for ($i=0; $i < $lignes; $i++) 
					{ 
